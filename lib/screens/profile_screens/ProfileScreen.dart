...
class _ProfileScreenState extends ConsumerState<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: FutureBuilder(
        future: ref.read(appServiceProvider).getUserProfile(),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          UiHelper.customTextField(_usernameController,
                              'Username', 'UserName', false),
                          UiHelper.customTextField(
                              _emailController, ' E-mail', 'Enter Mail', false),
                          UiHelper.customTextField(
                              _phoneController, 'Phone no', 'Phone No', false),
                          SizedBox(
                            height: height * .010,
                          ),
                          Padding(
